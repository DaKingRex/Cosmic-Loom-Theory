...
\normalsize Version: v1.1 (Zenodo release)}
...
\noindent\textbf{Keywords:} consciousness, effective field theory, Loomfield, non-equilibrium dynamics, coherence regimes, Energy Resistance, biological substrates, multi-scale integration, time-crystal--like ordering, falsifiability, dissipative structures
...
one substrate. Prediction~7 functions as an implicit additional falsifier:
...
already used in multi-modal neuroimaging to include substrate channels
beyond the neural.
