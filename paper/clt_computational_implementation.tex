...
\normalsize Version: v1.0 (Zenodo release)}
...
\noindent\textbf{Keywords:} consciousness, computational modeling, Loomfield, Energy Resistance, bioelectric fields, biophoton emission, microtubule time crystals, coherence metrics, open-source software, multi-substrate integration, falsifiability
...
Cosmic Loom Theory (CLT) v1.1 \citep{fraterne2026theory} proposes that
...
appear in CLT v1.1 \citep{fraterne2026theory}; here we emphasize the forms
...
\begin{figure}[htbp]
    ...
    \caption{Pathology zones and clinical trajectories in \'eR phase space. Seven pathological conditions---depression, anxiety, mania, seizure, dissociation, ADHD, and PTSD---are represented as dashed ellipses displaced from the viable window toward the chaos or rigidity boundaries. Three representative clinical trajectories illustrate decompensation and recovery dynamics: depression onset (declining energy and frequency toward the rigidity boundary), manic episode (spiking energy and frequency toward the chaos boundary), and therapeutic recovery (spiraling return from the anxiety region to the viable window). Circles mark trajectory start points; squares mark endpoints; arrows indicate direction of travel.}
...
Mur's first-order absorbing boundary condition~\citep{mur1981absorbing} is
...
lists 20 Python dependencies.  The repository layout is diagrammed in
...
(CLT v1.1) upon which this computational work is built.
